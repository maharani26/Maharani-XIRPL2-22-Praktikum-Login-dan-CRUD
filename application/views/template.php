                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/3.png"></span>
                                ...
                                <span class="message">
                                    I need information about cinema tickets
                                </span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/1.png"></span>
                                ...
                                <span class="message">
                                  Can't wait for the latest marvel movie
                                </span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/3.png"></span>
                                ...
                                <span class="message">
                                    a very entertaining film while on vacation
                                </span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?= base_url()?>assets/images/2.png"></span>
                                ...
                                <span class="message">
                                  With your website I'm easy to watch movies
                                </span>
                    </a>
                </li>
                <li>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img src="<?= base_url()?>assets/unch.jpg" style="width:40px; height:40px;">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
              <li>
                ...
                <li>
                    <a class="active" href="<?= base_url()?>index.php/gallery">
                ...
                <li>
                    <a class="active" href="<?= base_url()?>index.php/event">
                ...
                <li>
                    <a class="active" href="<?= base_url()?>index.php/diskon">
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <li>
                          ...
                          <li>
                              <a class="active" href="<?= base_url()?>index.php/Pelanggan/datapelanggan">
                            ...
                            <!-- <li class="header">MAIN NAVIGATION</li> -->
                                <a class="active" href="<?= base_url()?>index.php/user/Logout">
